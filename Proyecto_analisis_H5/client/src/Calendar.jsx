...
function Calendar({ nombre, apellido, rut, email }) {
  ...
  return (
    <div className="calendar-container">
      <div>
        <h2>Bienvenido, {nombre} {apellido} {email}</h2>
      </div>
      <div>
      ...
      {showEventForm && (
        <div className={`event-modal ${showEventForm ? 'show' : ''}`}>
          ...
          <form className="event-form">
            ...
            <input type="text" name="tipoExamen" value={selectedEvent?.tipoExamen || newEvent.tipoExamen} onChange={(e) => setSelectedEvent({ ...selectedEvent, tipoExamen: e.target.value })} />
      ...
      {showEdicion && (
        <div className={`event-modal ${showEdicion ? 'show' : ''}`}>
          ...
          <form className="event-form">
            ...
            <label>Tipo de Examen:</label>
            <input type="text" name="tipoExamen" value={selectedEdit?.tipoExamen || newEvent.tipoExamen} onChange={(e) => setselectedEdit({ ...selectedEdit, tipoExamen: e.target.value })} />
            <label>RUT del Personal Asociado:</label>
      ...
      {showEditForm && (
        <div className={`event-details-container ${showEditForm ? 'show' : ''}`}>
          <div className="event-details">
            ...
            <p>ID del Evento: {editFormEvent?.id}</p>
